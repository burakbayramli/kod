...
if sys.argv[1] == "acer_ext":
    ...
    os.system("python rsync.py '/home/burak/Downloads/campdata/book' '/media/burak/Seagate Backup Plus Drive/archive/data/campdata/book'")
