...
```python
import json
d = '{"pixels":[[17.723164443857968,475.3467543730512],[54.132053333334625,427.126049364917],[393.79057777673006,561.5153343658894]],"file": "/tmp/14/9515/6144.tile"}'
d = json.loads(d)
print (d)
```

```text
{'pixels': [[17.723164443857968, 475.3467543730512], [54.132053333334625, 427.126049364917], [393.79057777673006, 561.5153343658894]], 'file': '/tmp/14/9515/6144.tile'}
```
